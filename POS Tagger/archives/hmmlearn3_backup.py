...
def get_corpus_data():
    ...
    #actual= en_train_tagged
#     fin = open(sys.argv[1],"r",encoding='utf8')
    fin = open("en_train_tagged.txt","r",encoding='utf-8')
    corpus=[]
...
#           emissionsProb[emission]=math.log(numerator) - math.log(denominator)
...
#         transitionsProb[transition] = math.log(numerator) - math.log(denominator) 
